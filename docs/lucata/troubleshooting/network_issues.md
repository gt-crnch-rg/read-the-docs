This is a continuation of [running programs and diagnosing problems](https://github.com/gt-crnch-rg/read-the-docs/docs/lucata/troubleshooting/diagnosing_problems.md)
